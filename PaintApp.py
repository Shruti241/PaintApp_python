...
class Paint():
    def __init__(self,root):
        ...
        colors = ['#ff0000','#ff4dd2','#ffff33','#000000','#0066ff','#660033','#4dff4d','#b300b3','#00ffff','#808080','#99ffcc','#004d00']
        i=j=0
        for color in colors:
        ...
        #bind the canvas with the mouse drag
    ...
    def save_paint(self):
        try:
            ...
            x1 = x + self.canvas.winfo_width()  # x1 use to store the width of the canvas
            print(x1)
            y1 = y + self.canvas.winfo_height()  #y1 use to store the height of the canvas
            print(y1)
